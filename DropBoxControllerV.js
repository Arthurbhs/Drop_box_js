...
//configuração para coneção ao firebase
  connectFirebase() {
    const firebaseConfig = {
      apiKey: "AIzaSyAavVy4R951m1miSZHRuTlelEO2CnJRFUQ",
      authDomain: "drop-box-cloner.firebaseapp.com",
      databaseURL: "https://drop-box-cloner-default-rtdb.firebaseio.com",
      projectId: "drop-box-cloner",
      storageBucket: "drop-box-cloner.appspot.com",
      messagingSenderId: "787293622823",
      appId: "1:787293622823:web:4be27a554fd680d2e07402",
      measurementId: "G-77T3VBS6R5"
    }
  }
...
responses.forEach(reso => {
this.getFirebaseRef().push().set({name: responses.name,
                                  type: responses.contentType,
                                   path: responses.downloadURLs[0],
                                   size: responses.size});
    ...
    [...files].forEach((file) => {
      promises.push(new Promise((resolve, reject) => {
        ...
        task.on('state_changed', snapshot => {
          ...
          this.uploadProgress({loaded: snapshot.bytesTransferred,
          total: snapshot.totalBytes}, file)
          this.uploadProgress({
